<?php if( !class_exists('load')){
     ...
     class load{
          ...
          // load custom controller php file
          ...
          // load custom location php file
          public static function inc($name=null) {
                ...
                if( !is_null($name)){
                    if( is_dir($dir)){
                        require_once $dir . $slash_val . $view . $slash_val . __( $name ) . $php_val;
                    }
                }
